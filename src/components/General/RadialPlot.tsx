...
const CircularBarplot: React.FC<Props> = ({ data }) => {
    ...
    useEffect(() => {
        ...
        const onMouseOver = (event: MouseEvent, d: Data) => {
            ...
            const originalRadius = y(d.population) as number;
            ...
            d3.select(path)
                .attr('fill', 'grey')
                .attr('d', (d: any) => {
                    const startAngle = x(d.year) as number;
                    const endAngle = x(d.year) as number + x.bandwidth() as number;
            ...
            setHoveredRegion(d.year);
            setHoveredAmount(d.population);
        };
        ...
        const onMouseLeave = (event: MouseEvent, d: Data) => {
            ...
            d3.select(path)
                ...
                .attr('d', (d: any) => {
                    ...
                    const arcGenerator = d3.arc<Data>()
                        .innerRadius(innerRadius)
                        .outerRadius(y(d.population) as number)
                        .padAngle(0.04)
                        .padRadius(innerRadius);
        ...
        svg.selectAll('text')
            ...
            .attr('text-anchor', (d: any) => {
                ...
                if (d.year !== undefined && xValue !== undefined) {
            ...
            .attr('transform', (d: any) => {
                ...
                if (d.year !== undefined && xValue !== undefined) {
                    ...
                    const labelXTranslation = (turnLabelUpsideDown ? -1 : 1) * (y(d.population) + 10);
